...
public partial class @NewActions: IInputActionCollection2, IDisposable
{
    ...
    ~@NewActions()
    {
        UnityEngine.Debug.Assert(!m_Jugador.enabled, "This will cause a leak and performance issues, NewActions.Jugador.Disable() has not been called.");
    }
    ...
    public struct JugadorActions
    {
        ...
        /// </summary>
        public JugadorActions(@NewActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
